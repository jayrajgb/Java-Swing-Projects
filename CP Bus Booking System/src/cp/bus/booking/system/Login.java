...
public class Login extends JFrame implements ActionListener{
	...
	panel.add(passwordField);
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("CP/Bus/Booking/System/icons/user.png"));
	...
	panel.add(b3);
        ...
        b4 = new JButton("I am an Admin");
	b4.addActionListener(this);
	
        b4.setForeground(Color.BLACK);
	b4.setBackground(new Color(173, 216, 230));
	b4.setBounds(199, 281, 179, 25);
	panel.add(b4);
	...
	panel.add(l5);
        ...
        panel2.setBounds(24, 40, 434, 285);
        panel.add(panel2);
	}
